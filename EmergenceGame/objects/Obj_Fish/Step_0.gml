...
if(x < -1 * fish_margin) x = CAMERA_W + fish_margin - 1;
if(x > CAMERA_W + fish_margin) x = -1 * fish_margin + 1;
if(y < -1 * fish_margin) y = CAMERA_H + fish_margin - 1;
if(y > CAMERA_H + fish_margin) y = -1 * fish_margin + 1;
